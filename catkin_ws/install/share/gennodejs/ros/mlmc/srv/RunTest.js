...
class RunTestRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type RunTestRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type RunTestRequest
    let len;
    let data = new RunTestRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new RunTestRequest(null);
...
class RunTestResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type RunTestResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type RunTestResponse
    let len;
    let data = new RunTestResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new RunTestResponse(null);
...
module.exports = {
  ...
  md5sum() { return 'db324d824adf6dca3d2931e8d8ebd4ef'; },
  datatype() { return 'mlmc/RunTest'; }
};
