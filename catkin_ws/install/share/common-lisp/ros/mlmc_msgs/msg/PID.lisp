...
(cl:defmethod cl:initialize-instance :after ((m <PID>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PID)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mlmc_msgs-msg:<PID> is deprecated: use mlmc_msgs-msg:PID instead.")))

(cl:ensure-generic-function 'p-val :lambda-list '(m))
(cl:defmethod p-val ((m <PID>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mlmc_msgs-msg:p-val is deprecated.  Use mlmc_msgs-msg:p instead.")
  (p m))

(cl:ensure-generic-function 'i-val :lambda-list '(m))
(cl:defmethod i-val ((m <PID>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mlmc_msgs-msg:i-val is deprecated.  Use mlmc_msgs-msg:i instead.")
  (i m))

(cl:ensure-generic-function 'd-val :lambda-list '(m))
(cl:defmethod d-val ((m <PID>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mlmc_msgs-msg:d-val is deprecated.  Use mlmc_msgs-msg:d instead.")
  (d m))

(cl:ensure-generic-function 'ffd0-val :lambda-list '(m))
(cl:defmethod ffd0-val ((m <PID>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mlmc_msgs-msg:ffd0-val is deprecated.  Use mlmc_msgs-msg:ffd0 instead.")
  (ffd0 m))

(cl:ensure-generic-function 'ffd1-val :lambda-list '(m))
(cl:defmethod ffd1-val ((m <PID>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mlmc_msgs-msg:ffd1-val is deprecated.  Use mlmc_msgs-msg:ffd1 instead.")
  (ffd1 m))
